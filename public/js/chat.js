$(document).ready(function() {
    ...
    $('#saveChatBtn').click(function() {
        ...
        downloadAnchorNode.setAttribute("download", `ollama-chat-${new Date().toISOString().slice(0, 19).replace(/:/g, '-')}.json`);
    ...
    $('#testConnectionBtn').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                alert('Connection successful! Found ' + data.models.length + ' models.');
